...
namespace SistemaAtendimento.Repositories
{
    public class AtendimentoRepository
    {
        public List<Atendimentos> Listar(string termo = "", string condicao = "")
        {
            ...
            {
                string sql = @"SELECT a.*, c.nome AS cliente_nome,sa.nome AS situacao_atendimento, u.nome AS usuario_nome,c.cpf_cnpj 
                FROM atendimentos a 
                ...
                using (var comando = new SqlCommand(sql, conexao))
                {
                    ...
                    using (var linhas = comando.ExecuteReader())
                    {
                        lista.Add(new Atendimentos 
                        {
                            ...
                            SituacaoAtendimentoNome = linhas["situacao_atendimento"].ToString(),
